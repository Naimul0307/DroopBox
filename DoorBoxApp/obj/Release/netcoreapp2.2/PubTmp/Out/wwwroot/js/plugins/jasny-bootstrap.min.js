...
this.listen()
this.reset()}
Fileinput.DEFAULTS={clearName:!0}
...
this.$element.find('[data-dismiss="fileinput"]').on('click.bs.fileinput',$.proxy(this.clear,this))},Fileinput.prototype.verifySizes=function(files){if(typeof this.options.maxSize==='undefined')return!0
var max=parseFloat(this.options.maxSize)
if(max!==this.options.maxSize)return!0
...
this.$element.trigger('change.bs.fileinput')}},Fileinput.prototype.setImageTransform=function($img,file){var Fileinput=this;var reader=new FileReader();reader.onload=function(me){var transform=!1;var view=new DataView(reader.result);var exif=Fileinput.getImageExif(view);if(exif){Fileinput.resetOrientation($img,exif)}}
reader.readAsArrayBuffer(file)}
Fileinput.prototype.getImageExif=function(view){if(view.getUint16(0,!1)!=0xFFD8){return-2}
var length=view.byteLength,offset=2;while(offset<length){var marker=view.getUint16(offset,!1);offset+=2;if(marker==0xFFE1){if(view.getUint32(offset+=2,!1)!=0x45786966){return-1}
var little=view.getUint16(offset+=6,!1)==0x4949;offset+=view.getUint32(offset+4,little);var tags=view.getUint16(offset,little);offset+=2;for(var i=0;i<tags;i++){if(view.getUint16(offset+(i*12),little)==0x0112){return view.getUint16(offset+(i*12)+8,little)}}}
